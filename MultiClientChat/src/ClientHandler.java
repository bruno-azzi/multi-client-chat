...
public class ClientHandler implements Runnable {
  ...
  public ClientHandler(Socket socket) {
    try {
      ...
      List<String> splittedMessage = Arrays.asList(bufferedReader.readLine().split(" "));
      String author = splittedMessage.get(1);

      this.clientUsername = author;

      clientHandlers.add(this);
      broadcastMessage(new Message("newUserConnected", clientUsername, "ENTROU NO CHAT!").toString());
  ...
  public void broadcastMessage(String messageToSend) {
    ...
    if (type.equals("privateMessage")) {
      ...
      System.out.println(clientToReceiveMessage + " | " + body);
    }
